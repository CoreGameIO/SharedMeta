...
namespace SharedMeta.Test.Meta1
{
    ...
    public partial class AltConfigService : IAltConfigService
    {
        ...
        {
            // Reads typed Config — generated as `_config ?? (CounterAltConfig)Context.Config!`.
            // When invoked through Get{Iface}SiblingAsync(), the provider sets `_config =
            // CounterAltConfig` instance through the Config setter, so this method sees
