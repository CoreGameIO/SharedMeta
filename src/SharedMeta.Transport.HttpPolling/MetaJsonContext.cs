...
namespace SharedMeta.Transport.HttpPolling
{
    ...
    [JsonSerializable(typeof(SignalCallRequest))]
    [JsonSerializable(typeof(DebugOptionsRequest))]
    [JsonSerializable(typeof(DebugOptionsResponse))]
    [JsonSerializable(typeof(DesyncReportRequest))]
    [JsonSerializable(typeof(DesyncReportResponse))]
    [JsonSerializable(typeof(SessionResponse))]
    [JsonSerializable(typeof(SessionNotice))]
    [JsonSerializable(typeof(List<SessionNotice>))]
    ...
    [JsonSerializable(typeof(ResolveStatelessConfigVersionRequest))]
    [JsonSerializable(typeof(ResolveStatelessConfigVersionResponse))]
    [JsonSerializable(typeof(PollRequest))]
    [JsonSerializable(typeof(PollResponse))]
    [JsonSerializable(typeof(SessionOp))]
    [JsonSerializable(typeof(MetaOperation))]
    ...
    [JsonSerializable(typeof(List<MetaOperation>))]
