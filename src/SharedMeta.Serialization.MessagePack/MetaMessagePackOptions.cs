...
namespace SharedMeta.Serialization.MessagePack
{
    ...
    /// [MessagePackObject] types. This ensures cross-assembly generic serialization
    /// works correctly (e.g., EntityGrainState&lt;ProfileState&gt; where types live
    /// in different assemblies).
    ///
    /// Used by both MessagePackMetaSerializer (payload serialization)
    /// and SignalR MessagePack protocol (transport framing).
    /// </summary>
    public static class MetaMessagePackOptions
    {
        ...
        ///
        /// Call this at startup before creating MessagePackMetaSerializer or configuring SignalR.
        /// Order matters: resolvers are searched first-to-last. Put game assemblies first.
        /// </summary>
        /// <example>
        /// MetaMessagePackOptions.Configure(
        ///     typeof(ProfileState).Assembly,          // game state types
        ///     typeof(EntityGrainState&lt;&gt;).Assembly,  // framework grain state
        ///     typeof(AuthGrainState).Assembly,         // auth types
        ///     typeof(RpcCall).Assembly                 // core RPC types
        /// );
        /// </example>
